...
import { supabase, PresetQuestion, Conversation, Message } from '../lib/supabase';
...
export default function AIChat() {
  ...
  const handleSendMessage = async (content: string, presetQuestionId?: string) => {
      ...
      setTimeout(async () => {
        ...
        if (user.profile?.id) {
          await supabase.rpc('update_user_usage', {
            ...
            tokens: (userMessage.content.length / 4) + (aiMessage.tokens_used || 0),
  ...
  const groupedQuestions = presetQuestions.reduce((acc, question) => {
          ...
          <div className="space-y-4">
            ...
            {presetQuestions.length === 0 && (
              <div className="text-center py-8">
                ...
                <p className="text-sm text-gray-600">No preset questions available</p>
              </div>
            )}
          </div>
        </ScrollArea>
        ...
        <div className="p-4 border-t bg-white">
          <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
            <div className="flex space-x-2">
              ...
              />
              <Button type="submit" disabled={isLoading || !inputValue.trim() || !currentConversation}>
